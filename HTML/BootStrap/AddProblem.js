...
const CreateMarkdownEditor = (Title, Content) => {
    let VditorEditor;
    let Container = document.createElement("div"); AddProblemData.appendChild(Container);
...
let IOFilenameInputGroup = document.createElement("div"); AddProblemData.appendChild(IOFilenameInputGroup);
...
AddProblemData.appendChild(CreateHorizontalLine());

let DescriptionEditor = CreateMarkdownEditor("Description", "");
let InputEditor = CreateMarkdownEditor("Input", "");
let OutputEditor = CreateMarkdownEditor("Output", "");
let RangeEditor = CreateMarkdownEditor("Range", "");
let HintEditor = CreateMarkdownEditor("Hint", "");

let SamplesLabel = document.createElement("label"); AddProblemData.appendChild(SamplesLabel);
SamplesLabel.classList.add("col-form-label")
SamplesLabel.innerHTML = "Samples";
let SamplesTable = document.createElement("table"); AddProblemData.appendChild(SamplesTable);
...
let AddTestCaseButton = document.createElement("button"); AddProblemData.appendChild(AddTestCaseButton);
...
AddProblemSaveButton.onclick = () => {
    ...
    RequestAPI("AddProblem", {
        ...
        ShowSuccess("Add Problem Success");
        setTimeout(() => {
            SwitchPage("Problem", {
                "PID": PID.value
            });
