...
//     RETURN_IF_FAILED(UTILITIES::SaveFile(SettingBaseFolder + "/SocketPort", SocketPort))
//     RETURN_IF_FAILED(UTILITIES::SaveFile(SettingBaseFolder + "/WebTheme", WebTheme))
//     RETURN_IF_FAILED(UTILITIES::SaveFile(SettingBaseFolder + "/CompileTimeLimit", CompileTimeLimit))
//     RETURN_IF_FAILED(UTILITIES::SaveFile(SettingBaseFolder + "/CompileOutputLimit", CompileOutputLimit))
...
//     RETURN_IF_FAILED(UTILITIES::LoadFile(SettingBaseFolder + "/WebTheme", WebTheme))
...
// std::string SETTINGS::GetWebTheme() { return WebTheme; }
...
// void SETTINGS::SetWebTheme(std::string WebTheme) { this->WebTheme = WebTheme; }
